...
# 创建标准目录结构
mkdir -p "$PROJECT_DIR"/{说明书/考核试剂,说明书/对比试剂,说明书/其他同品种试剂盒说明书,指导原则,专家共识,竞品信息,审评报告,补充资料}
...
echo "  4. (可选) 其他已上市同类产品IFU 放入 说明书/其他同品种试剂盒说明书/"
echo "  5. (可选) 专家共识/竞品信息/审评报告 各放入对应目录"
echo "  6. (可选) 文献调研、医院LIS数据分析等 放入 补充资料/"
echo "  7. 运行: /ivd-00-orchestrator 项目名=$PROJECT_NAME"
